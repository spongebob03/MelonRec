...
def get_plylsts_embeddings(_train, _question, _submit_type):
    ...
    plylsts2vec(_train, t_plylst_title_tag_emb, w2v_model) # train plylsts to vectors
    plylsts2vec(_question, t_plylst_title_tag_emb, w2v_model)# val plylsts to vectors 
